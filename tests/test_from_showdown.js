...
strictEqual(
    conv.makeBBCode("<http://example.com/>"),
...
strictEqual(
    conv.makeBBCode("> This is a multi line blockquote test\n  >\n  > With more than one line."),
...
strictEqual(
    conv.makeBBCode("This is a normal paragraph:\n\n    This is a code block."),
...
strictEqual(
    conv.makeBBCode("This is some HTML:\n\n    <h1>Heading</h1>"),
...
strictEqual(
    conv.makeBBCode("These should all be escaped:\n\n\\\n\n\`\n\n\*\n\n\_\n\n\{\n\n\}\n\n\[\n\n\]\n\n\(\n\n\)\n\n\#\n\n\+\n\n\-\n\n\.\n\n\!"),
...
strictEqual(
    conv.makeBBCode("Define a function in javascript:\n\n```\nfunction MyFunc(a) {\n    var s = '`';\n}\n```\n\nAnd some HTML\n\n```html\n<div>HTML!</div>\n```"),
...
strictEqual(
    conv.makeBBCode("![Alt text](/path/to/img.jpg)\n\n![Alt text](/path/to/img.jpg \"Optional title\")\n\n![Alt text][id]\n\n  [id]: url/to/image  \"Optional title attribute\""),
...
strictEqual(
    conv.makeBBCode("Search the web at [Google][] or [Daring Fireball][].\n\n  [Google]: http://google.com/\n  [Daring Fireball]: http://daringfireball.net/"),
...
strictEqual(
    conv.makeBBCode("This is [an example](http://example.com/ \"Title\") inline link.\n\n[This link](http://example.net/) has no title attribute."),
...
strictEqual(
    conv.makeBBCode("Hello.this\_is\_a\_variable\nand.this.is.another_one"),
...
strictEqual(
    conv.makeBBCode("1.  This is a major bullet point.\n\n    That contains multiple paragraphs.\n\n 2.  And another line"),
...
strictEqual(
    conv.makeBBCode("See my [About](/about/) page for details."),
...
strictEqual(
    conv.makeBBCode("There's an [episode](http://en.memory-alpha.org/wiki/Darmok_(episode)) of Star Trek: The Next Generation"),
